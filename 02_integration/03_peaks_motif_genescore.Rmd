...
knitr::opts_chunk$set(echo = TRUE,include=T,message=F,eval = F)
```
...
This script uses ArchR wrappers to identify Peaks, Motif Deviations, and Gene Score Activity. These results are then inserted as individual "Assays" into the integrated `Large SeuratObject`.
...
tfsInHoco = names(hocomocoV10)[grep(str_c(tfsOfI, collapse = "|"), names(hocomocoV10))]
...
## Gene score activity with combined cells

## Adding data to integrated Seurat Object
