...
qsave(allModalities, "02_integration/rds/02_allModalities.qs", nthreads = 16)
```
...
ggsave("02_integration/figs/02_sctUMAP.png", plot = umap, width = 7, height = 6)
ggsave("02_integration/figs/02_sctUMAP_splitSamples.png", plot = umap_splitSample, width = 14, height = 6)
ggsave("02_integration/figs/02_sctUMAP_clsuters.png", plot = umap_clusters, width = 7, height = 6)
...
```{r eval = F}
qsave(sct_integrated, "02_integration/rds/02_sct_integrated.qs", nthreads = 16)
sct_integrated = qread("02_integration/rds/02_sct_integrated.qs")
```
...
ggsave("02_integration/figs/02_atacUMAP_CD3D.png", cd3d, width = 10, height = 5)xs
```
...
```{r}
qsave(sct_atac_combined,"02_integration/rds/02_sct_atac_combined.qs",nthreads=16)
...
ggsave("02_integration/figs/02_wnnUMAP.png",wnnumap, width = 6, height = 6)
ggsave("02_integration/figs/02_wnnUMAP_splitSample.png",wnnumap_split, width = 16, height = 6)
```
...
ggsave("02_integration/figs/02_wnnUMAP_MS4A1_rna.png",ms4a1rna, width = 16, height = 6)
ggsave("02_integration/figs/02_wnnUMAP_CD3D_rna.png",cd3drna, width = 16, height = 6)
